...
import { CrewMemberType, MovieDetailsInterface } from "@/types";
...
const page = async ({
	...
	const crew = await getCrew(searchParams.type, params.id);
						...
						<div
							...
							{item.profile_path !== null ? (
								<Image
									...
									height={500}
									alt={item.name}
									className="rounded-xl 2lg:group-hover:scale-[1.02] transition-transform object-cover h-[150px] md:h-[200px] xl:h-[250px]"
								/>
							) : (
